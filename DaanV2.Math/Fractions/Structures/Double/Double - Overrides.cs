...
namespace DaanV2.Math.Fractions {
    public readonly partial struct DoubleFraction : IEquatable<DoubleFraction> {
        ...
        /// <param name="other">The object to compare to</param>
        /// <returns>True or false if the object equal each other</returns>
        public Boolean EqualsValue(DoubleFraction other) {
        ...
        /// <returns>True or false if the object equal each other</returns>
        public Boolean EqualsValue(DoubleFraction other, Double error) {
            var temp = Math.Substract(this, other);
        ...
        /// <param name="other">The object to compare to</param>
        /// <returns>True or false if the object equal each other</returns>
        public Boolean EqualsValue(IFraction<Double> other) {
            var temp = Math.Substract(this, other);
        ...
        /// <param name="error">The allowed range of error</param>
        /// <returns>True or false if the object equal each other</returns>
        public Boolean EqualsValue(IFraction<Double>, Double error) {
            var temp = Math.Substract(this, other);
